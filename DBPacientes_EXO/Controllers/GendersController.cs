...
namespace DBPacientes_EXO.Controllers
{
    public class GendersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PatientGender")] Gender gender)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PatientGender")] Gender gender)
        {
            if (id != gender.Id)
            {
                return NotFound();
